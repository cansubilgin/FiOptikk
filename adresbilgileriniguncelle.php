...
<head>
    ...
    <title>Giriş Bilgilerini Güncelle | Fi Optik</title>
...
if(isset($_POST["btnguncelle"]))
{
    ...
    $adres=$_POST["txtadres"];
        ...
        $sorgu="UPDATE musteri SET il='$il',ilce='$ilce',adres='$adres' WHERE id=$id";
...
<form id="form1" name="form1" method="post" enctype="multipart/form-data" action=""><table border='1'>
        ...
        <tr><td>ADRESİNİZ:</td>
		 ...
		 <tr><td>İLİNİZ:</td>
            <td><input type="text" name="txtil" id="txtil" value="<?php echo $kayit["il"]; ?>"/>
            </td>
        </tr>
        <tr><td>İLÇENİZ:</td>
            <td><input type="text" name="txtilce" id="txtilce" value="<?php echo $kayit["ilce"]; ?>"/>
            </td>
        </tr>
        <tr><td colspan="2">
