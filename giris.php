...
<form id="form1"  method="post" enctype="multipart/form-data"><table border='1'>
        <tr><td>E-MAİL:</td>
...
{
	 $kullanici_mail=($_POST['txtmail']); 
	 $kullanici_password=($_POST['txtsifre']); 



	$kullanicisor=$baglan->prepare("SELECT * from musteri where email=:email and sifre=:sifre ");
	...
	if ($say==1) {
		...
		header("Location:hesabım.php?durum=girisbasarili");
		exit;
